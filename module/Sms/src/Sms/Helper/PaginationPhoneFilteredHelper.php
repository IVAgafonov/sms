...
class PaginationPhoneFilteredHelper extends AbstractHelper
{
    ...
    public function __invoke($pagedResults, $page, $baseId, $filter, $baseUrl, $resultsPerPage = 10)
    {
    ...
    private function generatePaging()
    {
        ...
        if ($pages <= 5 ) {
            ...
            if ($this->page != 1) {
                $this->paging = "<a href='". $this->baseUrl . "/" . $this->baseId . "/1";
                if ($this->filter != '') {
            ...
            while ($pageCount <= $pages) {
                $this->paging .= "<a href='" .$this->baseUrl. "/" . $this->baseId . "/" . $pageCount;
                if ($this->filter != '') {
                    $this->paging .= "/".$this->filter;
                }
                $this->paging .= "'";
            ...
            if ($this->page != $pages) {
                $this->paging .= "<a href='" . $this->baseUrl . "/" . $this->baseId . "/". $pages;
                if ($this->filter != '') {
                    $this->paging .= "/".$this->filter;
                }
                $this->paging .= "'>></a>";
            ...
            if ($this->page != 1) {
                $prev = $this->page-1;
                $this->paging = "<a href='". $this->baseUrl . "/" . $this->baseId . "/".$prev;
                if ($this->filter != '') {
                    $this->paging .= "/".$this->filter;
                }
                $this->paging .= "'";
            ...
            $this->paging .= "<a href='" .$this->baseUrl. "/" . $this->baseId . "/" . $this->page;
            if ($this->filter != '') {
                $this->paging .= "/".$this->filter;
            }
            $this->paging .= "'";
            ...
            if ($this->page != $pages) {
                $next = $this->page+1;
                $this->paging .= "<a href='" . $this->baseUrl . "/" . $this->baseId . "/". $next;
                if ($this->filter != '') {
                    $this->paging .= "/".$this->filter;
                }
                $this->paging .= "'";
